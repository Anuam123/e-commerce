            ...
            <div class="pull-right">
                @can('subcategory-create')
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('subcategory.create') }}"
                        ...
                        <i class="material-icons right">add_circle_outline</i> Create New SubCategory</a>
                @endcan
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($subcategory as $key => $subcat)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">{{ $subcat->created_at }}</td>
                                            <td style="text-align: center;">{{ $subcat->sub_category_name }}</td>
                                                ...
                                                <div class="row">
                                                    <div class="col s12">
                                                        ...
                                                        @can('subcategory-edit')
                                                            <a href="{{ route('subcategory.edit', $subcat->id) }}"><i
